...
type Payment = { id: string; amount: number; status: string; status_label?: string; utr: string | null; created_at: string; rejection_reason?: string };
...
export default function Payments() {
  ...
  return (
    <View style={[s.root, { paddingTop: insets.top }]}>
      ...
      <UpiSheet invoiceId={payInvoice} visible={!!payInvoice} onClose={() => setPayInvoice(null)} />
    </View>
  );
}
